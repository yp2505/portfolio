...
const CARD_TEXTURE_PATH = '/assets/yug.png';
...
function Band({ isMobile, maxSpeed = 50, minSpeed = 10 }) {
  ...
  return (
    <>
      {/* Position centered relative to container [0, 4, 0] instead of [3, 4, 0] */}
      <group position={[0, 4, 0]}>
        <RigidBody ref={fixed} {...segmentProps} type="fixed" />
        <RigidBody position={[0.2, 0, 0]} ref={j1} {...segmentProps}><BallCollider args={[0.1]} /></RigidBody>
        <RigidBody position={[0.4, 0, 0]} ref={j2} {...segmentProps}><BallCollider args={[0.1]} /></RigidBody>
        <RigidBody position={[0.6, 0, 0]} ref={j3} {...segmentProps}><BallCollider args={[0.1]} /></RigidBody>
